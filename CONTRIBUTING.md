# Contributing to brc-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
brc-schema. These guidelines are not strict rules.
...
The brc-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the brc-schema technical leads
...
[issues]: https://github.com/bioenergy-research-centers/brc-schema/issues/
[pulls]: https://github.com/bioenergy-research-centers/brc-schema/pulls/
