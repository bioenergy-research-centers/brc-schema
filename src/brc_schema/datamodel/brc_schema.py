...
# Generation date: 2024-05-11T18:35:54
# Schema: datasets
#
# id: https://w3id.org/brc/metaprot-datasets-schema
# description: This schema defines the structure for metabolomics and proteomics datasets, capturing essential metadata including investigators, affiliations, data citation, organism details, analysis type, and more.
...
BALD = CurieNamespace('bald', 'http://example.org/UNKNOWN/bald/')
...
slots.dataset__repository = Slot(uri=BRC.repository, name="dataset__repository", curie=BRC.curie('repository'),
                   model_uri=BRC.dataset__repository, domain=None, range=Optional[str])
